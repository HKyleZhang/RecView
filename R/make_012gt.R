...
#' @usage make_012gt(path = "...", F0F1_rename = c("PGF", "PGM", "MGF", "MGM", "Father", "Mother"), save_filename = "gt_012.csv", compact = FALSE)
...
#'
#' @export
make_012gt <- function(path, F0F1_rename = "no_rename", save_filename = "gt_012.csv", compact = FALSE) {
